...
<p align="center">
  <img src="icons/icon128.png" width="96" alt="TinyPalette logo">
</p>
...
| Primary | `#DFA7B0` soft blush pink |
| Secondary | `#C8B6E8` pastel lavender |
| Accent | `#B8C8E8` soft blue |
| Text | `#4A4650` dark gray purple |
...
For local development / unpacked loading:

1. Open `chrome://extensions`
2. Enable **Developer mode**
3. Click **Load unpacked**
4. Select the `TinyPalette` folder
